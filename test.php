...
<?php
  ...
  ///$answer=scrape_between($data1,$start,$end);
	...
	$tag="trim";
    $w3add="http://in3.php.net/manual/en/function.";
	$url=$w3add.$tag.".php";
   ...
   $results_page = scrape_between($results_page, "<div id=\"refsect1-function.trim-examples\">", "<div id=\"refsect1-function.trim-notes\">"); // Scraping out only the middle section of the results page that contains our results
